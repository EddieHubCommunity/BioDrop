...
export default function EventPreview({ event, username }) {
  return (
    <div className="flex flex-col rounded grow md:rounded-full md:flex-row border-2 border-gray-200 hover:border-gray-500 p-4 my-2 px-6">
      <div className="grow">
      ...
      <div className="min-w-fit">
        ...
        Join <a href={username}>{username}</a> at this{" "}
