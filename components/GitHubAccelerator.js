          ...
          <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
            ...
            <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0">
              <Link
                ...
                className="inline-flex justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-primary-high dark:text-primary-high shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-primary-low dark:hover:bg-slate-200 cursor-pointer"
                target="_blank"
              >
                <FaGithub
              ...
              <Link
                ...
                className="inline-flex justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold dark:text-primary-high shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-primary-low dark:hover:bg-slate-200 cursor-pointer"
                target="_blank"
              >
                <FaMoneyBillAlt
                  className="-ml-0.5 mr-1.5 h-5 w-5 text-primary-high dark:text-primary-high"
