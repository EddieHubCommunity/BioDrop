...
export default function GitHubAccelerator() {
  return (
    <div className="mb-12">
      <div className="bg-contain bg-no-repeat bg-center h-32 sm:h-40 md:h-44 l:h-48 md:bg-cover " style={{ backgroundImage: 'url(https://user-images.githubusercontent.com/624760/235968674-01cc3149-f9c3-48e2-9dc5-677789de8456.png)' }}>
      </div>
