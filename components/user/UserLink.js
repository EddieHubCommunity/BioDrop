...
export default function UserLink({ BASE_URL, link, username }) {
  ...
  return (
    <Link
      ...
      className="rounded-full border-2 border-gray-200 dark:border-gray-500 hover:border-[color:var(--hover-color)] hover:shadow-xl p-4 my-2 w-full content-start flex flex-row gap-4 items-center"
      style={{
