...
export default function UserLink({ BASE_URL, link, username }) {
  ...
  return (
    <Link
      ...
      className="rounded-full border-2 border-primary-low-medium dark:border-primary-medium dark:hover:border-[color:var(--hover-color)] hover:border-[color:var(--hover-color)] hover:shadow-xl p-4 my-2 w-full content-start flex flex-row gap-4 items-center dark:bg-primary-medium"
      style={{
