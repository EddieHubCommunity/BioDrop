  ...
  return (
    <ul role="list" className="divide-y divide-primary-low">
      {repos.map((repo) => (
        <li
          key={repo._id}
          className="relative flex justify-between gap-x-6 px-4 py-5 hover:bg-primary-low dark:hover:bg-primary-medium transition-all duration-100 sm:px-6 lg:px-8"
        >
          <div className="flex gap-x-4">
            ...
            <div className="min-w-0 flex-auto">
              ...
              <p className="mt-1 flex text-xs leading-5 text-primary-low-medium ">
                {repo.description}
              </p>
            </div>
          </div>
