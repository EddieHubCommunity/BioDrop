              ...
              <Link
                ...
                className={classNames(
                  tab.key === eventType
                    ...
                    : "border-transparent text-primary-medium dark:text-secondary-low-medium dark:hover:text-secondary-low-medium hover:text-primary-medium hover:border-primary-low-medium",
