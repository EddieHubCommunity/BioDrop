    ...
    <div>
      <div className="sm:hidden">
        ...
        <select
          ...
          className="block w-full rounded-md border-gray-300 dark:focus:border-indigo-400 dark:focus:ring-indigo-400  focus:border-indigo-500 focus:ring-indigo-500"
