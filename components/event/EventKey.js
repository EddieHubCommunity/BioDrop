    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 mb-6">
      {filters.map((filter) => (
        <div
          ...
          className="hover:scale-105 cursor-pointer transition-all 3s relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-white dark:border-none dark:bg-dark px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2"
          key={filter.key}
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-gray-200">{filter.title}</p>
