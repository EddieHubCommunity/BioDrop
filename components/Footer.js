  ...
  return (
    <footer className="pt-12 pb-14 px-4 sm:px-6 md:flex md:justify-between">
      <Link
        ...
        className="text-primary-medium hover:text-primary-high dark:text-primary-low-medium dark:hover:text-gray-200 flex justify-center space-x-6 md:order-2 gap-2"
      >
