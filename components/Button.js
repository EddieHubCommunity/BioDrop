...
export default function Button({
  ...
  let className =
    "w-full inline-flex items-center flex-1 justify-center rounded-md border border-secondary-high px-5 py-3 text-base font-medium first-letter:bg-white transition duration-400 ease-in-out";
  !disable
    ? (className += primary
