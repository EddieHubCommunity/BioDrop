...
test("Guest user cannot access premium stats", async ({ browser }) => {
...
test("Logged in free user cannot access premium stats", async ({ browser }) => {
...
test("Logged in premium user can access premium stats", async ({ browser }) => {
