...

        {
            show
                ...
                ( <
                    ...
                    <
                    ShareIcon link = {
                        `https://www.facebook.com/sharer/sharer.php?u=https://linkfree.eddiehub.org/${username}`
                    }
                    ...
                    <
                    ShareIcon link = {
                        `https://twitter.com/intent/tweet?text=Check out my LinkFree profile! https://linkfree.eddiehub.org/${username}`
                    }
                    ...
                    <
                    ShareIcon link = {
                        `https://www.linkedin.com/sharing/share-offsite?url=https%3A%2F%2Flinkfree.eddiehub.org%2F${username}`
                    }
                    ...
                    <
                    GetIcons className = "w-2rem h-2rem my-2rem cursor-pointer mx-5 share-icons copyLink"
                    iconName = "link"
                    size = {
                        20
                    }
