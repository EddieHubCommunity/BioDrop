    ...
    <>
      ...
      <Page>
        ...
        <Input
          name={gitUsername}
          value={gitUsername}
          className="dark:bg-primary-high dark:text-white border-2 hover:border-orange-600"
        ...
        <textarea
          ...
          className="mt-4 h-80 dark:bg-primary-high dark:text-white border-2 hover:border-orange-600 transition-all duration-250 ease-linear rounded px-6 py-2 mb-4 block w-full"
          name="profileJson"
          value={profileJson}
          onChange={(e) => {
