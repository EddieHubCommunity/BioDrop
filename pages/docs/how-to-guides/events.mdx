...
| road                   | true     | In which road, the event is hosting                         |
| city                   | true     | In which city, the event is hosting                         |
| state                  | true     | In which state, the event is hosting                        |
| country                | true     | In which country, the event is hosting                      |
