...
{
  "userStatus": "speaking",
  "speakingTopicDetails": {
  "topic": "Cloud Computing with Spring Cloud"
  },
  "isVirtual": true,
  "isInPerson": true,
  "color": "red",
...
| :--------------------- | :------- | :---------------------------------------------------------- |
| userStatus             | true     | Is user attending or speaking. (attending / speaking)       |
| speakingTopicDetails   | false    | Topic on you are speaking in the event.                     |
