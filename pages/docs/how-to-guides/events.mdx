...
3. This `json` file will contain one object for the event and must have seven fields, `startingFrom`,`isVirtual`and/or`isInPerson`, `color`, `name`, `description`, `date`and`url`, which will look like this:
...
| :--------------------- | :---------------------------------------------------------- |
| startingFrom           | What is the cost to attend event in USD.                    |
