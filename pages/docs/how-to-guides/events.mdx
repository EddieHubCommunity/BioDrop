...
1. Create a folder that matches your GitHub username and in that folder create another folder called `events`, for example `data/sarajaoude/events/`

2. In your folder add a `json` file with any name you like but we recommend to put the date first and then append it with the event, for example `2023-09-13-javacsript-conference.json`.
