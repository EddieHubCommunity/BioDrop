...
17. Once merged your profile will be available a few minutes later on the same custom url (for example: <Link href="https://linkfree.io/SaraJaoude">`https://linkfree.io/SaraJaoude`</Link>)
...
export default ({ children }) => (
  <DocsLayout title="LinkFree Editing Profile Documentation" section="Customising your Profile" name="Editing Profile">
    {children}
  </DocsLayout>
);
