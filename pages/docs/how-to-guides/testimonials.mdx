...
**NOTE: Don't have a Linkfree account but want to give a testimonial? No worries! Log in to your Github account (if you don't have one, check out Eddie's course(https://www.eddiejaoude.io/portal) to help you) and follow the above steps.
