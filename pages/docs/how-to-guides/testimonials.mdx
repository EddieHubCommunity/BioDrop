...
**NOTE**: Don't have a LinkFree account but want to give a testimonial? No worries! Log in to your GitHub account (if you don't have one, check out [Eddie's course](https://www.eddiejaoude.io/course-github-profile-landing) to help you) and follow the steps above.
