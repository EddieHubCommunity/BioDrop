...
![BioDrop Testimonial Profile example](https://user-images.githubusercontent.com/624760/210418401-3337352a-ee07-4b38-b929-f62209e27be4.png)

### Giving a Testimonial

You can give a Testimonial for another BioDrop user by going to their Profile and clicking on the "Add testimonial" button. This will take you to GitHub issue with the fields pre-populated for that user and you can fill in your testimonial.

The issue will look like this:

![BioDrop testimonial issue](https://user-images.githubusercontent.com/34659530/266554144-5943eaed-5244-4dcf-9797-e15bf2cdf6b6.png)
