...
> - _**Correct**_: `BioDrop/data/EddieJaoude.json` (including capitalisation in filename)
> - _**Incorrect**_: `BioDrop/data/eddiejaoude.json` (filename capitalisation does not match username capitalisation)
