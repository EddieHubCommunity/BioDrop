...
We use <Link url="https://storybook.js.org">Storybook</Link> to display what React components are available to use within our project. This also gives you the opportunity to play with the components' functionality and data it displays.
...
1. Import the component into the story file, see the existing <Link url="https://github.com/EddieHubCommunity/LinkFree/blob/main/stories/components/user/UserLink.stories.js">example</Link>
