...
1. Import the component into the story file, see the existing <Link href="https://github.com/EddieHubCommunity/BioDrop/blob/main/stories/components/profile/ProfileLink.stories.js">example</Link>
...
export default ({ children }) => (
  <DocsLayout
    title="BioDrop StoryBook Documentation"
