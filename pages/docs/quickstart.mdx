...
<Alert
  ...
  message={
    <>
      <strong>NOTE</strong>: Please use the online{" "}
      <Link href="https://jsonlint.com">JSON Lint</Link> tool to check if your
      JSON file is <i>error free</i> before committing your pull request.
    </>
  }
/>
