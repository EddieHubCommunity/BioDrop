...
| icon  | string | The icon you would like displayed. We support the following icon sets: **Fa** and **Si** from React Icons. You can search available <a href="https://linkfree.eddiehub.io/icons" target="_blank">icons here</a>  |
