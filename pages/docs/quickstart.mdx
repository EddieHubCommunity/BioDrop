...
2. Visit the <Link url="https://github.com/EddieHubCommunity/LinkFree">LinkFree repo</Link>
...
![compare across forls](https://user-images.githubusercontent.com/82668196/208292189-513b4213-a3a7-4a45-a834-ac6ce6b9217a.png)
...
19. Once merged your profile will be available a few minutes later on your custom url (<Link url="https://linkfree.eddiehub.io/SaraJaoude">linkfree.eddiehub.io/SaraJaoude</Link>)
...
- <Link url="https://github.com/EddieHubCommunity/LinkFree/blob/main/data/eddiejaoude.json">
    Eddie Jaoude
  </Link>
- <Link url="https://github.com/EddieHubCommunity/LinkFree/blob/main/data/krupalitrivedi.json">
    Krupali Trivedi || Chai
  </Link>
- <Link url="https://github.com/EddieHubCommunity/LinkFree/blob/main/data/Pradumnasaraf.json">
    Pradumna Saraf
  </Link>

### Next steps

- How to <Link url="/docs/how-to-guides/editing">edit and add more</Link> to your profile
- Add <Link url="/docs/how-to-guides/socials-shortcuts">social shortcuts</Link> to your profile
- Add <Link url="/docs/how-to-guides/tags">tags</Link> to your profile
- Add <Link url="/docs/how-to-guides/events">events</Link> to your profile
- Add <Link url="/docs/how-to-guides/testimonials">testimonials</Link> to your profile
