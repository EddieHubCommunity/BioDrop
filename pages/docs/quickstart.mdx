...
LinkFree uses multiple GitHub actions to automate different processes. If you want to turn off any workflows in your forked repository, you can find instructions at this [here](https://docs.github.com/en/actions/managing-workflow-runs/disabling-and-enabling-a-workflow)
