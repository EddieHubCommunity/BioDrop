...
7. In the file path at the top, add `data/` followed by your GitHub username and then append `.json` to it.

Please take care of the capitalization of your username.
