...
import Heading from "@components/mdx/Heading.js";

<Heading fontSize="large" customClasses="mt-6 mb-6"> You can setup LinkFree code base in the following two ways. </Heading>

<Heading id="docker-compose">1. Docker Compose (recommended)</Heading>
...
<Heading id="local" fontSize = "text-3xl">2. Complete local development setup (advanced)</Heading>
