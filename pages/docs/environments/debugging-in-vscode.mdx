...
<Alert
  ...
  message={
    <>
      <strong>NOTE: </strong>
        This debugging setup is for a local development environment and may not work if you are running LinkFree using Docker Compose in your local setup. Additionally, it requires MongoDB to be available and running.
    </>
  }
/>
