...
We have already configured the debugging environment for the Next.js by adding `launch.json` in the `.vscode` folder. By following the steps below, you can start debugging.
