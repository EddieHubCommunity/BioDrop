...
1. Make sure you have forked and cloned the [LinkFree](https://github.com/EddieHubCommunity/LinkFree) repository and have installed the dependencies. Also, make sure you are in the root directory of the project.
