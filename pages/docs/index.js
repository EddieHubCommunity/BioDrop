      ...
      <Page>
        ...
        {sections.map((section) => (
          <div
            ...
            key={section.title}
          >
            <div className="relative mx-auto max-w-lg divide-y-2 divide-primary-low dark:divide-primary-medium-low lg:max-w-7xl">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-primary-high dark:text-primary-low sm:text-4xl">
                  {section.title}
                </h2>
                <p className="mt-3 text-xl text-primary-medium dark:text-primary-medium-low sm:mt-4">
                  {section.description}
                </p>
              </div>
                ...
                {section.pages.map((page) => (
                  ...
                  >
                    ...
                    <Link href={page.path} className="mt-4 block">
                      ...
                      <p className="mt-3 text-base text-primary-medium dark:text-primary-medium-low">
                        {page.description}
                      </p>
                    </Link>
                  </div>
