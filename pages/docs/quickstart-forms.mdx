...
4. This will take you to the GitHub login page. After successful login to GitHub you will automatically be redirected back to LinkFree where you will see the Form:
...
6. Your Profile will be then be available on your custom URL (linkfree.io/eddiejaoude)
